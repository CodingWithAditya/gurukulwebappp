...
import Mobile from "../../assets/mainlogo.png";
    ...
    <HomeSection id="home">
      ...
      <MainContent id="home">
        <Lb id="leftBlock">
          ...
          <Topic>
            <Circle/>
            <span>Chat,Chai Aur Charcha</span>
          </Topic>
          <SubText>
            ये गलियाँ ये चौबारा यहाँ आते सब दोबोरा 
          </SubText>
          <CTA href="#about" onClick={(e) => scrollUp("testimonial", e)}>
            Get Started &nbsp;
